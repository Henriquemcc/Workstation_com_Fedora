...
.EXAMPLE
    PS /> ./Install-SnapPackage.ps1 -Package "spotify"
    This example installs Spotify.
.EXAMPLE
    PS /> ./Install-SnapPackage.ps1 -Package @("spotify", "skype")
    This example installs Spotify and Skype.
.EXAMPLE
    PS /> ./Install-SnapPackage.ps1 -Package "code" -Classic
